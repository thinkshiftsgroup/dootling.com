...
const HeatmapConnections = () => {
    const connections = [
        ...
        },
        {
            ...
            icon: (
                <Image src="/images/icon/icons8-jira-48.png" width={48} height={48} alt='icon' className="w-12 h-12"/>
            ),
            granted: 'Apr 5, 2024',
        ...
        },
        {
            ...
            icon: (
                <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 384"><path fill="#0acf83" d="M64 384c35.328 0 64-28.672 64-64v-64H64c-35.328 0-64 28.672-64 64s28.672 64 64 64"></path><path fill="#a259ff" d="M0 192c0-35.328 28.672-64 64-64h64v128H64c-35.328 0-64-28.672-64-64"></path><path fill="#f24e1e" d="M0 64C0 28.672 28.672 0 64 0h64v128H64C28.672 128 0 99.328 0 64"></path><path fill="#ff7262" d="M128 0h64c35.328 0 64 28.672 64 64s-28.672 64-64 64h-64z"></path><path fill="#1abcfe" d="M256 192c0 35.328-28.672 64-64 64s-64-28.672-64-64s28.672-64 64-64s64 28.672 64 64"></path></svg>
            ),
            granted: 'Mar 28, 2024',
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-8">
                        ...
                        <div className="space-y-0 rounded-sm shadow-sm py-5">
                            {connections.map((connection, index) => (
                                <div
                                    key={connection.name}
                                    className={`flex items-center justify-between py-6 px-5 ${index !== connections.length - 1 ? 'border-b border-gray-100' : ''
                                        }`}
                                >
