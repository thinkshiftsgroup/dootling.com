                                ...
                                <div className="p-6 py-3">
                                    ...
                                    <div className="p-3 px-6 shadow-md rounded-sm m-auto bg-white">
                                        ...
                                        <div className="flex gap-4 mb-8">
                                            ...
                                            >
                                                <div className={`w-5 h-5 rounded-full border-2 ${selectedType === 'financial' ? 'border-gray-200 bg-[#157BFF]' : 'border-[#157BFF]'
                                                    }`}></div>
                                                Financial Proof
                                            </button>
                                            <button
                                            ...
                                            >
                                                <div className={`w-5 h-5 rounded-full border-2 ${selectedType === 'work' ? 'border-gray-200 bg-[#157BFF]' : 'border-[#157BFF]'
                                                    }`}></div>
                                                Work File
                                            </button>
                                        </div>
