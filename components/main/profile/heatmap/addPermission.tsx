    ...
    return (
        <div className="">
            ...
            <div className="max-w-2xl">
                ...
                {!isOpen && (
                    <button
                        onClick={() => setIsOpen(true)} className="bg-[#157BFF] hover:bg-blue-600 text-white px-2 py-1 rounded-sm flex items-center gap-2 transition-colors text-[0.9rem]">
                        <svg
                            className="w-5 h-5"
                            fill="none"
                            stroke="currentColor"
                            ...
                            <div className="fixed inset-0 flex items-center justify-center p-4 z-50 animate-fadeIn">
                                <div className="p-10 pt-2 overflow-y-scroll hide-scrollbar shadow-md max-w-3xl w-full max-h-[92vh] rounded-sm m-auto animate-slideUp bg-white">
                                        ...
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <span className="text-amber-600 font-bold">D</span>
                                                ...
                                                <Image
                                                    ...
                                                    alt="icon"
                                                />
                                                <h1 className="text-2xl font-bold text-gray-900">Connect Works</h1>
                                            </div>


                                            <p className="text-[#157BFF] text-sm">...you can turns work itself into the network</p>
                                    ...
                                    <div className="space-y-8">
                                        {/* Apps selection */}
                                        <div>
                                            <h2 className="text-lg font-bold text-gray-900 mb-4">Apps, Workspaces & Work Tools</h2>
                                            <input
                                                type="text"
                                                placeholder="Choose the app or tool you'd like to connect"
                                                className="w-full px-4 py-3 border border-[#f1f1f1] rounded-lg text-gray-700 focus:border-blue-500 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#157BFF]"
                                            />
                                            <p className="text-sm text-gray-500 mt-3">
                                                We'll only track activity metadata – never your private content.
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-3 flex-wrap">
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg font-semibold transition-colors flex items-center gap-2 ${selectedPermissions.includes('activity')
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg font-semibold transition-colors flex items-center gap-2 ${selectedPermissions.includes('project')
                                                        ? 'bg-[#157BFF] text-white'
                                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                        }`}
                                                >
                                        ...
                                        {/* Connection Method */}
                                        <div>
                                            <h2 className="text-lg font-bold text-gray-900 mb-4">Connection Method</h2>
                                            <div className="space-y-3 flex items-center gap-6">
                                                <label className="flex items-center gap-1.5 cursor-pointer m-0">
                                                    <input
                                                        ...
                                                        className="w-4 h-4"
                                                    />
                                                    <span className="text-gray-900 font-medium">OAuth</span>
                                                </label>
                                        ...
                                        <label className="flex items-start gap-3 cursor-pointer">
                                            ...
                                            <span className="text-gray-700">
                                                I understand Dootling only tracks metadata, not my private data or content.
                                            </span>
                                        </label>

                                        {/* Buttons */}
                                        <div className="flex justify-end gap-3 pt-6">
                                            <button  onClick={() => setIsOpen(false)} className="px-6 py-2 text-gray-600 font-medium hover:text-gray-900 transition-colors cursor ">
                                                Cancel
                                            </button>
                                            <button className="px-6 py-2 bg-[#157BFF] hover:bg-blue-600 text-white font-semibold rounded-sm transition-colors flex items-center gap-2">
                                                Connect Work <svg xmlns="http://www.w3.org/2000/svg" width={23} height={23} viewBox="0 0 24 24">
