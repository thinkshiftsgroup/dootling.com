            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
              ...
              <div className="bg-white p-6 rounded-lg max-w-md">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span
                      className={`absolute top-[3px] left-1 w-6 h-6 bg-white rounded-full transition-transform ${
              ...
              <button
                onClick={handleCopy}
                className="w-full flex items-center justify-center gap-2 rounded-sm font-semibold text-lg text-black py-4 cursor-pointer bg-[#FDC70C1A]"
              >
                <svg
