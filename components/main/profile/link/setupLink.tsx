                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                            ...
                            <div className="bg-white p-6 rounded-lg max-w-md">
                                ...
                                <div className="mb-6">
                                    <div className="relative w-40 h-40 rounded-2xl overflow-hidden border-4 border-gray-100">
                                        <img
                                        ...
                                        {/* Camera Icon Button */}
                                        <button className="absolute bottom-3 right-3 w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
                                            <svg
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`relative w-16 h-8 rounded-full transition-colors ${isActive ? 'bg-blue-600' : 'bg-gray-300'
                                            }`}
                                    >
                                        <span
                                            className={`absolute top-[3px] left-1 w-6 h-6 bg-white rounded-full transition-transform ${isActive ? 'translate-x-8' : 'translate-x-0'
                                                }`}
                                        />
                                    </button>
                                </div>
                            ...
                            <button onClick={handleCopy} className="w-full flex items-center justify-center gap-2 rounded-sm font-semibold text-lg text-black py-4 cursor-pointer bg-[#FDC70C1A]">
                                ...
                                <svg
                                    className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
