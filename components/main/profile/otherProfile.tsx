              ...
              <div className="p-5">
                <div className="flex flex-col space-y-4">
                  <div className="">
                    ...
                    <div
                      className={`transition-all max-h-[400px] p-4 duration-300 overflow-hidden `}
                    >
                ...
                <div id="profileTabContent" className="tab-content active show">
                    ...
                    <div className="space-y-4 text-[#7e8b9a]">
                      <div>
                        ...
                        <p className="text-sm leading-relaxed text-[#7e8b9a]">
                          Hi, I’m Bni, I’m 26 and I work as a Web Designer for
                          the iqonicdesign. I like to ride the bike to work,
                          swimming, and working out. I also like reading design
                          magazines, go to museums, and binge watching a good TV
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-[#7e8b9a] font-medium text-sm">
                        You will receive a link to download your export via
                        email once we are able to fulfill your request.
                      </p>
                    </div>
                  </div>
                </div>
