                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                            <div>
                                ...
                                <div className="flex my-2">
                                    ...
                                    <input
                                        type="text"
                                        className="w-full border border-[#f1f1f1] rounded-md text-sm  bg-white z-10 text-gray-600 p-2 border-gray-400/50"
                                    />
                                </div>
                            </div>
