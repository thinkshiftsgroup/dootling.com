                ...
                <div className="flex w-full h-[110px] overflow-y-scroll hide-scrollbar flex-col justify-between gap-3 p-2 bg-white shadow-md min-w-[250px] rounded">
                    ...
                    <div className="flex items-center justify-between mt-2">
                        <p
                            ...
                            className={`text-xs cursor-pointer transition-colors duration-200 ${activeTab === "transactions" ? "text-black" : "text-gray-300"
                                }`}
                        >
                            All Transactions
                        </p>
                ...
                <div className="flex w-full h-[110px] overflow-y-scroll hide-scrollbar flex-col justify-between gap-3 p-2 bg-white shadow-md min-w-[250px] rounded">
                    ...
                    <div className="mt-2">
                        <p
                            ...
                            className={`text-xs pt-1 cursor-pointer transition-colors duration-200 ${activeTab === "escrow" ? "text-black" : "text-gray-300"
                                }`}
                        >
...
const ProjectDashboard: React.FC<ProjectDashboardProps> = ({
    ...
    return (
        <div className="w-full bg-gray-50 py-8">
            ...
            {ConfirmCPEscrow && <ConfirmConvertProjectToEscrow setOpenModal={setConfirmCPEscrow} />}
            <ManageProject
                open={manageProject}
