...
const ConfirmConvertProjectToEscrow = ({ setOpenModal }: { setOpenModal: (open: boolean) => void }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-screen h-screen bg-black/50 flex items-center justify-center z-50">
            <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-lg shadow-lg max-w-sm w-full mx-4">
                ...
                <div className="p-6">
                    <p className="text-gray-700">
                        Are you sure you want to convert this project to escrow?
                    </p>
                </div>
