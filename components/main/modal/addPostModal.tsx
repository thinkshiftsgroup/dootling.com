        ...
        <>
            ...
            duration-200`}>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <button className="text-gray-400 hover:text-gray-600 transition-colors">
                                            ...
                                            <button className="text-gray-400 hover:text-gray-600 transition-colors">
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 24 24"><path fill="currentColor" d="M12.004 11.73q.667 0 1.14-.475t.472-1.143t-.476-1.14t-1.143-.472t-1.14.476t-.472 1.143t.475 1.14t1.144.472M12 19.677q2.82-2.454 4.458-4.991t1.638-4.39q0-2.744-1.737-4.53Q14.62 3.981 12 3.981T7.641 5.766t-1.737 4.53q0 1.852 1.638 4.39T12 19.677m0 1.342q-3.525-3.117-5.31-5.814q-1.786-2.697-1.786-4.909q0-3.173 2.066-5.234Q9.037 3 12 3t5.03 2.062q2.066 2.061 2.066 5.234q0 2.212-1.785 4.909q-1.786 2.697-5.311 5.814m0-10.903" strokeWidth={0.8} stroke="currentColor"></path></svg>
                                            </button>
                                        </div>
                                        ...
                                        <button className="flex items-center gap-2 text-gray-400 hover:text-gray-600 transition-colors">
                                            ...
                                            <span className="text-sm font-medium text-gray-300">Add to Dootling</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center px-6 py-4">
                                <Dropdown
                                    trigger={
                                        <span className="text-lg text-gray-400 font-medium">Anyone can reply and quote</span>
                                    }
