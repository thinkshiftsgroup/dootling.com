  ...
  const tasks = [
    {
      ...
      users: ["John", "Mike"],
      progress: "40%",
      releaseDate: "23rd November 2025",
      status: "Completed",
      rule: "23rd ...",
    },
    {
              ...
              <React.Fragment key={index}>
                <tr className="hover:bg-[#E7F1FF]/10">
                  ...
                  <td className="py-3 px-2 text-gray-600 text-sm text-center">
                    ...
                    <span
                      ...
                      className="text-[#157bff] cursor-pointer text-[10px] sm:!text-xs"
                    >
                ...
                {expandedRow === index && (
                  <tr className="bg-[#E7F1FF]/20">
                    <td colSpan={7} className="py-3 px-4 text-sm text-gray-700">
                      <p>Here are the full details for this task…</p>
                    </td>
                  </tr>
                )}
              </React.Fragment>
