...
const DootimeIn = () => {
  ...
  return (
    <div className="container mx-auto md:bg-white md:shadow-sm md:rounded-sm md:grid md:grid-cols-10">
      <div className="md:col-span-4 md:border-r p-6 relative md:h-auto h-[85vh]">
        ...
        <div className="mt-3 mb-5">
          <p className="text-sm leading-relaxed text-gray-700">
            ...
            the fog, clear the noise, and give you a roadmap that actually makes
            sense for where you are — and where you’re going...
          </p>
          ...
          >
            <p className="text-sm leading-relaxed text-gray-700 mt-3">
              💡 In this session, we’ll dig into your current strategy, uncover
              the real blockers holding you back, and craft a practical
              step-by-step plan to move forward with confidence. No fluff, no
              vague advice — every insight is tailored to you and your goals.
            </p>
          </div>
