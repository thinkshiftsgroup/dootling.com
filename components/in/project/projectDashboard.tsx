...
import InvitedProjectsContent from "@/components/main/profile/project/invitedProjectContent";
import PeerConfirmationContent from "@/components/main/profile/project/peerConfirmationContent";
import MyProjectsContent from "./projectContent";
import EscrowProjectsContent from "./escrowProjectContent";
    ...
    <div className="w-full bg-gray-50 sm:!py-8 py-4">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm p-3 sm:!p-6">
          ...
          {activeTab === "my-projects" && (
            <MyProjectsContent projects={data} isLoading={isLoading} />
          )}
          {activeTab === "escrow-projects" && (
