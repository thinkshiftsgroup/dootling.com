                  ...
                  <div id="content">
                    <div className="flex flex-wrap pb-4">
                      <div className="w-full">
                        <div className="mb-5">
                          <div id="stories" className="storiesWrapper flex gap-3"></div>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-wrap pb-4">
                      <div className="w-full">
                        <div id="post-modal-data" className="rounded-lg shadow bg-white create-post-modal">
                          <div className="flex justify-between items-center p-4 border-b border-[#f1f1f1]">
                            <div className="header-title">
                              <h5 className="text-xl font-semibold">Add a Post</h5>
                            </div>
                            <div className="relative">
                              <div className="leading-none cursor-pointer" id="post-option">
                                <i className="ph-bold ph-dots-three text-3xl text-body"></i>
                              </div>
                              <div className="hidden absolute right-0 mt-2 bg-white rounded-lg shadow-lg"
                                aria-labelledby="post-option">
                                <a className="block px-4 py-2 hover:bg-gray-100" href="#"
                                  data-bs-toggle="modal" data-bs-target="#post-modal">Check in</a>
                                <a className="block px-4 py-2 hover:bg-gray-100" href="#"
                                  data-bs-toggle="modal" data-bs-target="#post-modal">Live Video</a>
                                <a className="block px-4 py-2 hover:bg-gray-100" href="#"
                                  data-bs-toggle="modal" data-bs-target="#post-modal">GIF</a>
                                <a className="block px-4 py-2 hover:bg-gray-100" href="#"
                                  data-bs-toggle="modal" data-bs-target="#post-modal">Watch Party</a>
                                <a className="block px-4 py-2 hover:bg-gray-100" href="#"
                                  data-bs-toggle="modal" data-bs-target="#post-modal">Play with Friend</a>
                              </div>
                            </div>
                          </div>
                          <div className="p-4">
                          ...
                          <div className="bg-blue-50 rounded-b-lg p-4">
                            <div className="flex items-center justify-between flex-wrap gap-3">
                              ...
                              <div>
                                <ul className="flex items-center gap-4 m-0 p-0 list-none">
                                  <li>
                                    <a href="javascript:void(0);" className="text-body font-medium">
                                      Discard
                                    </a>
                                  </li>
                                  <li>
                                    <button type="button"
                                      className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Post</button>
                                  </li>
                                </ul>
                              </div>
                            </div>
                      ...
                      <div className="w-full social-post mb-4">
                        <div className="rounded-lg shadow bg-white">
                          <div className="p-4">
                              ...
                              <div className="flex items-center justify-between gap-2 lg:gap-3">
                                ...
                                <div className="w-full">
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h6 className="mb-0 inline-block">Anna Sthesia</h6>
                                      <span className="inline-block text-blue-600">
                                        <i className="ph-fill ph-seal-check"></i>
                                      </span>
                                      <span className="mb-0 inline-block capitalize font-medium">posted an
                                        update</span>
                                    ...
                                    <div className="card-post-toolbar">
                                      <div className="relative">
                                        ...
                                        <div
                                          className="hidden absolute right-0 mt-2 bg-white rounded-lg shadow-lg m-0 p-0">
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              <i className="ph ph-floppy-disk text-2xl"></i>
                                              <div className="data">
                                                <h6 className="font-semibold">Save Post</h6>
                                                <p className="mb-0 text-sm">Add this to your saved
                                                  items</p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6 className="font-semibold">Hide Post</h6>
                                                <p className="mb-0 text-sm">See fewer posts like this.
                                                </p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6 className="font-semibold">Unfollow User</h6>
                                                <p className="mb-0 text-sm">Stop seeing posts but stay
                                                  friends.</p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                ...
                                                <p className="mb-0 text-sm">Turn on notifications for
                                                  this post</p>
                                              </div>
                                            </div>
                                          </a>
                            ...
                            <div className="mt-4">
                              <p className="m-0">"Energy, the tangible expression of pure thought, propels
                                intentions into powerful actions, bridging the gap between mind and
                                manifestation."</p>
                              <ul className="flex flex-wrap gap-1 m-0 p-0 list-none">
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#friends</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#party</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#birthday</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#together</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#celebration</a>
                                </li>
                              </ul>
                            </div>
                            ...
                            <div className="post-meta-likes mt-4">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <div className="inline-flex items-center gap-1">
                                  ...
                                  <span className="capitalize text-sm font-medium cursor-pointer">and 208
                                  ...
                                  <div className="like-data">
                                    <div className="relative">
                                      <span
                                        ...
                                        <span className="font-medium">140 Likes</span>
                                      </span>
                                    </div>
                                  </div>
                                </div>
                      ...
                      <div className="w-full social-post mb-4">
                        <div className="rounded-lg shadow bg-white">
                          <div className="p-4">
                            <div className="user-post-data">
                              <div className="flex items-center justify-between gap-2 lg:gap-3">
                                ...
                                <div className="w-full">
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h6 className="mb-0 inline-block">Barb Ackue</h6>
                                      <span className="inline-block text-blue-600">
                                        <i className="ph-fill ph-seal-check"></i>
                                      </span>
                                      <span className="mb-0 inline-block capitalize font-medium">Add a New
                                        Post</span>
                            ...
                            <div className="mt-4">
                              <p className="m-0">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
                                nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus
                                mollis pharetra. Proin blandit ac massa sed rhoncus"</p>
                              <ul className="flex flex-wrap gap-1 m-0 p-0 list-none">
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#family</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#happiness</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#travelling</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#camping</a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);" className="text-blue-600">#climbing</a>
                                </li>
                              </ul>
                            </div>
                            <div className="user-post mt-4">
                            ...
                            <div className="post-meta-likes mt-4">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <div className="inline-flex items-center gap-1">
                                  <h6 className="m-0 text-sm">Aliana Molex</h6>
                                  <button className="capitalize text-sm font-medium cursor-pointer"
                                    type="button" data-bs-toggle="modal" data-bs-target="#likemodal">and
                                    208 others liked this</button>
                                </div>
                              </div>
                            </div>
                            <div className="comment-area mt-4 pt-4 border-t">
                                ...
                                <div className="like-block relative flex items-center flex-shrink-0">
                                  <div className="like-data">
                                    <div className="relative">
                                      ...
                                      <div
                                        className="hidden absolute mt-2 bg-white rounded-lg shadow-lg py-2">
                              ...
                              <div className="hidden mt-4 pt-4 border-t" id="commentcollapes2">
                                      ...
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="comment-list-user-data">
                                          <div className="inline-flex items-center gap-1 flex-wrap">
                                            ...
                                            <span className="font-medium text-sm capitalize">3 min
                                              ago</span>
                                          </div>
                                        </div>
                                      </div>
                                      <div className="comment-list-user-comment">
                                        ...
                                        <div className="comment-list-action mt-2">
                                          <ul className="flex items-center gap-2 m-0 p-0 list-none">
                                            <li>
                                              <div
                                                className="like-block relative flex items-center flex-shrink-0">
                                                <div className="like-data">
                                                  <div className="relative">
                                                    <span
                                                      className="cursor-pointer flex items-center justify-center gap-1"
                                          ...
                                          <div className="add-comment-form-block hidden mt-3"
                        ...
                        <div className="rounded-lg shadow bg-white">
                          <div className="p-4">
                            <div className="user-post-data">
                              <div className="flex items-center justify-between gap-2 lg:gap-3">
                                ...
                                <div className="w-full">
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h6 className="mb-0 inline-block">Ira Membrit</h6>
                                      <span className="inline-block text-blue-600">
                                        <i className="ph-fill ph-seal-check"></i>
                                      </span>
                                      <span className="mb-0 inline-block capitalize font-medium">Update her
                                        Status</span>
                            ...
                            <div className="comment-area mt-4 pt-4 border-t">
                              ...
                              <div className="hidden mt-4 pt-4 border-t" id="commentcollapes3">
                                <ul className="m-0 p-0 list-none comment-list">
                                  <li className="mb-3">
                                    <div className="comment-list-block">
                                      <div className="flex items-center gap-3">
                                                ...
                                                <div className="like-data">
                                                  <div className="relative">
                                                    <span
                                                      ...
                                                      <i className="ph ph-thumbs-up text-3xl"></i>
                                                      <span
                                                        className="font-medium text-sm">Likes</span>
                                                    </span>
                                                    <div
                                                      className="hidden absolute mt-2 bg-white rounded-lg shadow-lg py-2">
                                                      <a className="mx-2 inline-block"
                        ...
                        <div className="rounded-lg shadow bg-white">
                          <div className="p-4">
                            <div className="user-post-data">
                              <div className="flex items-center justify-between gap-2 lg:gap-3">
                                ...
                                <div className="w-full">
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h6 className="m-0 inline-block">Bni Cyst</h6>
                                      <span className="inline-block text-blue-600">
                                        <i className="ph-fill ph-seal-check"></i>
                                      </span>
                                      <span className="m-0 inline-block capitalize font-medium">Added
                                        ...
                                        <div
                                          ...
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6>Save Post</h6>
                                                <p className="m-0 text-sm">Add this to your saved items
                                                </p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6>Hide Post</h6>
                                                <p className="m-0 text-sm">See fewer posts like this.
                                                </p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6>Unfollow User</h6>
                                                <p className="m-0 text-sm">Stop seeing posts but stay
                                                  friends.</p>
                                              </div>
                                            </div>
                                          </a>
                                          <a className="block p-3 hover:bg-gray-50" href="#">
                                            <div className="flex items-start gap-2">
                                              ...
                                              <div className="data">
                                                <h6>Notifications</h6>
                                                <p className="m-0 text-sm">Turn on notifications for
                                                  this post</p>
                                              </div>
                                            </div>
                                          </a>
                            ...
                            <div className="comment-area mt-4 pt-4 border-t">
                              ...
                              <div className="hidden mt-4 pt-4 border-t" id="commentcollapes4">
                                <ul className="m-0 p-0 list-none comment-list">
                                  <li className="mb-3">
                                    <div className="comment-list-block">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="comment-list-user-data">
                                          <div className="inline-flex items-center gap-1 flex-wrap">
                                            ...
                                            <span className="font-medium text-xs capitalize">3 min
                                              ago</span>
                                          </div>
                                        </div>
                                      </div>
                                      <div className="comment-list-user-comment">
                                        ...
                                        <div className="comment-list-action mt-2">
                                          <ul className="flex items-center gap-2 m-0 p-0 list-none">
                                                ...
                                                <div className="like-data">
                                                  <div className="relative">
                                                    <span
                                                      ...
                                                      <span
                                                        className="font-medium text-xs">Likes</span>
                                                    </span>
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <li>
                                              <span
                                                className="font-medium text-xs cursor-pointer">Reply</span>
                                            </li>
                                          </ul>
                                          <div className="add-comment-form-block hidden mt-3"
